...
export const Hero = () => {
  return (
    <div className="my-16 flex flex-row gap-x-24 items-center container mx-auto">
        <div className="py-16">
            <h1 className="leading-none text-gray-900 font-extrabold text-6xl">Building digital products & brands.</h1>
